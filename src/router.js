...
export const appRouter = [
    ...
    // },
    {
        ...
        component: Main,
        children: [
            {path: 'account-manage', title: '账号管理', name: 'account-manage', component: resolve => { require(['./views/people-management/account-manage.vue'], resolve)}},
            {path: 'group-manage', title: '组管理', name: 'group-manage', component: resolve =>{ require(['./views/people-management/group-manage.vue'], resolve)}},
            {path: 'role-manage', title: '角色管理', name: 'role-manage', component: resolve => { require(['./views/people-management/role-manage.vue'], resolve)}}
        ]
    },
    {
        path: '/pages',
